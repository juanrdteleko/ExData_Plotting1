...
with(inSub_d,plot(DT,Global_active_power, col="black",type = "l", main="",ylab = "Global Active Power",xlab = ""))                ## First Plot
...
with(inSub_d,plot(DT,Global_reactive_power, col="black",type = "l", main="",xlab="datetime",ylab = "Global_reactive_power"))             ## Forth Plot

dev.copy(png,file = "plot4.png",width = 480, height = 480)      ##lets create the png file
dev.off() 